...
data_path = Path('data')
img_data_path = data_path /"train_data/images_data.npz"
train_data_path = data_path / "train_data/train_data.npz"
valid_data_path = data_path / "validation_images"
negative_samples_dir = train_data_path
